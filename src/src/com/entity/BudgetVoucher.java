...
/**
 * 预算凭证
 * BudgetVoucher entity. @author MyEclipse Persistence Tools
 */

public class BudgetVoucher implements java.io.Serializable {
...
/*--------------最后一次修改的字段----------*/
	...
	private int VStatus;                 //状态  隐藏1-显示0
...
/*-----------------------------gettings and settings------------------------*/
	...
	public BudgetVoucher(String id, String vType, String vNo, String vDate, String vAbstract, String vDebitAmount,
			...
			String vEconomic, String vFunctional, String vBudgetItems, String vReimbursement, String vRemarks, String vStatus) {
		super();
		this.id = id;
		VType = vType;
		VNo = vNo;
	...
	public String toString() {
		return "AccountingVoucher [id=" + id + ", VType=" + VType + ", VNo=" + VNo + ", VDate=" + VDate + ", VAbstract="
				...
				+ ", VBudgetItems=" + VBudgetItems + ", VReimbursement=" + VReimbursement + ", VRemarks=" + VRemarks+ ", VStatus=" + VStatus
				+ "]";
	}
}